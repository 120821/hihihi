...
class ApplicationController < ActionController::Base
  ...
  before_action :check_user_have_email
  def check_user_have_email
    if current_user.present? && current_user.email.include?("noemail")
      redirect_to '/the_users/show_complete_email_page'
    end
  end
