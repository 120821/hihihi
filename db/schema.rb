...
ActiveRecord::Schema[7.0].define(version: 2022_03_17_064206) do
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.string "eth_address", default: "", comment: "ETH address"
    t.string "polka_address", default: "", comment: "Polka address"
    t.string "wallet_type", default: "", comment: "wallet type , e.g. ETH, Polka, BTC"
